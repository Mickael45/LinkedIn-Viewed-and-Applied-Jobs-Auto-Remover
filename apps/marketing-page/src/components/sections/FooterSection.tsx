...
export const FooterSection = ({ onGetStartedClick }: FooterProps) => (
  <>
    ...
    <footer className="bg-gray-900 text-gray-400 py-2 px-6 text-xs">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        <a href="mailto:mickael.gomes@example.com" className="hover:text-white">
          Contact
        </a>
        <p>Powered by Mickael Gomes</p>
      </div>
    </footer>
  </>
);
